...
%% 设置页面布局
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\RequirePackage[a4paper,left=3cm,right=2.5cm,bottom=2.5cm,top=2.5cm,%设置页面上下各为25mm
headheight=1.5cm,%页眉所占高度
footskip=1.0cm %页脚所占高度
]{geometry}
...
% 几个\renewcommand主要是为了防止出现条但样式为“一.1.”，   让它为“一、 （一）、1.”样式
\renewcommand\thesection{\arabic{section}}
\renewcommand\thesubsection{\arabic{subsection}}
\renewcommand\thesubsubsection{\arabic{subsubsection}}
\titleformat{\subsection}{\bf\normalsize}{(\thesubsection) \,}{0.24em}{} %这个到底是半角但括号还是全角，很纠结
...
\fancyhead[LE]{}
\fancyhead[LO]{}
\fancyhead[CO]{\wuhao{华南理工大学}}
\fancyhead[CE]{\wuhao{研究生学位（毕业）论文文献综述}}% 
...
%	\addtolength{\parskip}{0pt}
	...
	\renewcommand*{\bibfont}{ \xiaosihao} %建议的\heiti 特别丑
